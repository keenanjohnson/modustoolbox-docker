...
#
-include $(MTB_TOOLS__PRJ_DIR)/libs/mtb.mk
...
_MTB_TOOLS__INCLUDE_BASELIB:=true

ifneq ($(CY_SKIP_RECIPE),)
_MTB_TOOLS__INCLUDE_BASELIB:=false
endif
...
ifeq ($(_MTB_TOOLS__INCLUDE_BASELIB),false)
...
ifeq ($(_MTB_TOOLS__INCLUDE_BASELIB),true)
...
.PHONY: getlibs printlibs vscode eclipse get_app_info build program help_start
