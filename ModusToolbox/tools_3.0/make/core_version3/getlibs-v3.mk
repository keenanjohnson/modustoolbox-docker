...
ifneq ($(wildcard $(CY_TOOL_proxy-helper_EXE_ABS)),)
_MTB_TOOLS__PROXY_HELPER_CMD=$(CY_TOOL_proxy-helper_EXE_ABS) --exec --
endif
...
printlibs:
	...
	echo ==============================================================================;\
    for dir in $$(ls -RA $(CY_GETLIBS_PATH) $(SEARCH_MTB_MK) | grep .git:); do\
        dir="$$(dirname $$dir)";\
