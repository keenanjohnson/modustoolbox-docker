...
ifeq ($(strip $(filter 2 1 0,$(MTB__MAKE_MINOR_VER))),)
...
ifeq ($(strip $(filter 1 0,$(MTB__MAKE_MINOR_VER))),)
...
mtb__file_write=$(shell echo '$(subst ',\',$(subst \,\\,$2))' >$1)
endif
...
mtb__file_append=$(shell echo '$(subst ',\',$(subst \,\\,$2))' >>$1)
endif
