...
# 1.X, 2.X, 3.X
_MTB__MAKE_4_3_OR_NEWER:=false
else
ifeq (4,$(MTB__MAKE_MAJOR_VER))
ifneq (,$(strip $(filter 2 1 0,$(MTB__MAKE_MINOR_VER))))
# 4.0, 4.1., 4.2
_MTB__MAKE_4_3_OR_NEWER:=false
else
# 4.X, X >=3
_MTB__MAKE_4_3_OR_NEWER:=true
endif
else
# X.Y, X > 4
_MTB__MAKE_4_3_OR_NEWER:=true
...
ifeq (true,$(_MTB__MAKE_4_3_OR_NEWER))
...
CY_WHITESPACE_VARS_LIST=CURDIR \
	...
	CY_GETLIBS_CACHE_PATH CY_GETLIBS_DEPS_PATH CY_GETLIBS_PATH CY_GETLIBS_SEARCH_PATH \
