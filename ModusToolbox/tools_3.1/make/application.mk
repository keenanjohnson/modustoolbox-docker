...
printlibs eclipse vscode uvision5 ewarm8 uvision ewarm:
	@:
...
.PHONY: get_app_info getlibs all build qbuild program qprogram clean printlibs eclipse vscode uvision5 ewarm8 uvision ewarm
