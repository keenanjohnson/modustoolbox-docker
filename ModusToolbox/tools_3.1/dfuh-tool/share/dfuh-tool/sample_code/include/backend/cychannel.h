...
class CyChannel : boost::noncopyable {
   ...
   public:
    ...
    /// Specified .mtbdfu file was not found
    const static int CYCHANNEL_MTBDFU_NOT_FOUND = 0x0D;
    /// .mtbdfu file has incorrect configuration
    const static int CYCHANNEL_MTBDFU_CONFIGURATION_ERROR = 0x0E;
    ...
    virtual void print() const {
        cydfuht::core::cyDebug() << QString::fromLatin1("Interface:    %1\nTarget Name:  %2\n")
    ...
    /// Variable to abort waiting for data(in cases when )
    bool abort = false;
